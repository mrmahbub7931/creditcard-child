<?php 
	...
	# Template name: Personal Loan Details
	get_header();
 ...
 ?>
 	...
 	<div class="loan_details_wrap">
 		<?php $page_header = $options['page_header']; ?>
 		...
 		<div class="container-fluid">
 			...
 			<?php $loan_details_parent = $options['loan_details_parent'];
 			if (isset($loan_details_parent) && is_array($loan_details_parent)) :
 			$i = 0;
 			foreach ($loan_details_parent as $single_value): ?>
