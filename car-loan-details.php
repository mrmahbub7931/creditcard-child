<?php 
	...
	# Template name: Car Loan Details
	get_header();
 ...
 ?>
 	...
 	<div class="loan_details_wrap">
 		<?php $page_header = $options['c_page_header']; ?>
 		...
 		<div class="container-fluid">
 			...
 			<?php $car_loan_details = $options['car_loan_details'];
 			if (isset($car_loan_details) && is_array($car_loan_details)) :
 			$i = 0;
 			foreach ($car_loan_details as $single_value): ?>
