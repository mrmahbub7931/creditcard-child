...
add_action('wp_ajax_custom_contact_form', 'loancard_custom_contact_form_callback');
add_action('wp_ajax_nopriv_custom_contact_form', 'loancard_custom_contact_form_callback');
...
function loancard_custom_contact_form_callback()
{
	global $wpdb;
	$table = $wpdb->prefix.'loancard_contact';
