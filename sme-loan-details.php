<?php 
	...
	# Template name: Sme Loan Details
	get_header();
 ...
 ?>
 	...
 	<div class="loan_details_wrap">
 		<?php $page_header = $options['s_page_header']; ?>
 		...
 		<div class="container-fluid">
 			...
 			<?php $sme_loan_details = $options['sme_loan_details'];
 			if (isset($sme_loan_details) && is_array($sme_loan_details)) :
 			$i = 0;
 			foreach ($sme_loan_details as $single_value): ?>
