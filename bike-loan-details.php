<?php 
	...
	# Template name: Bike Loan Details
	get_header();
 ...
 ?>
 	...
 	<div class="loan_details_wrap">
 		<?php $page_header = $options['b_page_header']; ?>
 		...
 		<div class="container-fluid">
 			...
 			<?php $bike_loan_details = $options['bike_loan_details'];
 			if (isset($bike_loan_details) && is_array($bike_loan_details)) :
	 			$i = 0;
	 			foreach ($bike_loan_details as $single_value): ?>
